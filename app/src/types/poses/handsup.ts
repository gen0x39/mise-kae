...
export const HandsupPose: VRMPose = {
  // 中央部・頭部
  ...
  leftUpperArm: { rotation: [0, 0, -0.5, 0.866], position: [0, 0, 0] },
  leftLowerArm: { rotation: [0, 0, -0.3, 0.954], position: [0, 0, 0] },
  ...
  rightLowerArm: { rotation: [0, 0, 0.3, 0.954], position: [0, 0, 0] },
